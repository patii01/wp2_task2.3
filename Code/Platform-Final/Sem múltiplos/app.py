...
now = parser.parse("2024-05-28 19:39:41.572 +0100")
dates.append("2024-05-28 19:39:41+00:00")
...
position_graph = html.Div([
    ...
    html.Div(id='selection-series-content', children=[
        html.Div([
            html.Label('Source Target', style={'margin-left': '270px'}),
            dcc.Dropdown(
                id='target',
    ...
    html.Div(id='compare-series-content', style={'display': 'none'}, children=[
        html.Div([
            html.Label('Series', style={'margin-left': '270px'}),
            dcc.Dropdown(
                id='series',
...
forecast_chaser_graph = html.Div([
    ...
    html.Div(id='series-content2', children=[
        html.Div([
            html.Label('Chaser Source', className='label'),
            dcc.Dropdown(
                id='selection_series',
    ...
    html.Div(id='compare-content2', children=[
        html.Div([
            html.Label('Chaser Sources', className='label'),
            dcc.Dropdown(
                id='compare_series',
                options=[{'label': i, 'value': i} for i in target_chaser_values],
...
forecast_target_graph = html.Div([
    ...
    html.Div(id='series-content3', children=[
        html.Div([
            html.Label('Target Source', className='label'),
            dcc.Dropdown(
    ...
    html.Div(id='compare-content3', children=[
        html.Div([
            html.Label('Target Sources', className='label'),
            dcc.Dropdown(
                id='compare_series1',
                options=[{'label': i, 'value': i} for i in target_chaser_values],
                placeholder="Selection of series",
