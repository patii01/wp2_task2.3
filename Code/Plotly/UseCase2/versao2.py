...
def update_plot(target, chaser, btn1, btn2, btn3, btn4):
    ...
    active_class = 'tab-button active'
    inactive_class = 'tab-button'
    ...
    if target is None or chaser is None:
        ...
        if button_id == 'btn-2':
            ...
            return fig, inactive_class, active_class, inactive_class, inactive_class
        elif button_id == 'btn-3':
            plot(fig, target, chaser, max_value, colorN, 3)
            return fig, inactive_class, inactive_class, active_class, inactive_class
        elif button_id == 'btn-4':
            plot(fig, target, chaser, max_value, colorN, 4)
            return fig, inactive_class, inactive_class, inactive_class, active_class
        else:
            plot(fig, target, chaser, max_value, colorN, 1)
            return fig, active_class, inactive_class, inactive_class, inactive_class
    ...
    fig.update_layout(
        ...
        margin=dict(l=50, r=20, t=55, b=0) 
    )
    return fig, inactive_class, inactive_class, inactive_class, inactive_class  
