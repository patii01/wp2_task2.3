...
def update_plot(relayoutData):
    ...
    for dt in dataSets:
        if dt == "Ephemeris":
            fig.add_trace(
                go.Scatter(
                    x=dataSets[dt]['dt_time'], y=dataSets[dt]['dt'], 
                    mode='lines+markers', name=dataSets[dt]['name'],
                    marker=dict(size=13, color=dataSets[dt]['color'], symbol='x'), 
                    line=dict(color=dataSets[dt]['color'])
                )
            )
            ...
            fig.add_trace(
                go.Scatter(
                    x=dataSets[dt]['dt_time'], y=dataSets[dt]['dt'], 
                    mode='lines+markers', name=dataSets[dt]['name'],
                    marker=dict(size=10, color=dataSets[dt]['color']), 
                    line=dict(color=dataSets[dt]['color'])
                )
            )
    ...
    fig.add_shape(
        type='line', x0=now, y0=0, x1=now, y1=max_value + 100, line=dict(color='black', width=1), 
    ...
    for f in forecasts:
        ...
        fig.add_trace(
            go.Scatter(
                x=forecast_data['dt_time'], y=forecast_data['upper_bound'],
