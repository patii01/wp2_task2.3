...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Label('Switch between views'),
            daq.BooleanSwitch(
                id='boolean-switch',
                on=False
            ),
        ...
        ], style={'display': 'block'}),  # Ensure initial visibility
        
        html.Div(id='compare-series-content', children=[
            html.Div([
                dcc.Dropdown(
                    id='compare_series',
                    options=[{'label': i, 'value': i} for i in target_chaser_values],
        ...
        ], style={'display': 'none'}),  # Ensure initial visibility
...
@app.callback(
    ...
    Input('selection', 'value'),
    Input('position_graph', 'selectedData')
)
...
@app.callback(
    ...
    Input('compare_series', 'value'),
    Input('multiple_graph', 'selectedData')
)
